...
class QAProcessor:
    def __init__(self):
        self.reference_questions = self.load_reference_questions()
    
    def load_reference_questions(self):
        """Load reference questions"""
        reference_json_str = '''
        [
   {
                "marks": 1,
                "question": "What do you understand by Resources?",
                "reference_answer": "Resources refer to the materials or assets that can be used to create value, including natural resources like water and minerals, and human resources such as knowledge and skills."
            },
            {
                "marks": 1,
                "question": "Which states in India are rich in minerals and coal deposits?",
                "reference_answer": "Jharkhand, Chhattisgarh, Odisha, and West Bengal are some of the states in India rich in minerals and coal deposits."
            },
            {
                "marks": 1,
                "question": "Which report in 1987 introduced the concept of sustainable development?",
                "reference_answer": "The Brundtland Report, formally known as 'Our Common Future', introduced the concept of sustainable development in 1987."
            },
            {
                "marks": 1,
                "question": "What is total geographical area of India?",
                "reference_answer": "The total geographical area of India is approximately 3.287 million square kilometers."
            },
            {
                "marks": 1,
                "question": "How much degraded land is in India?",
                "reference_answer": "Approximately 130 million hectares of land in India are degraded."
            },
            {
                "marks": 2,
                "question": "What do you understand by international resources? Give example.",
                "reference_answer": "International resources are resources that are shared by multiple countries or exist in international waters, such as ocean fish stocks. For example, the fishing rights in the North Atlantic Ocean are an international resource."
            },
            {
                "marks": 4,
                "question": "Mention some features of soil.",
                "reference_answer": "Some features of soil include texture (which can be sandy, loamy, or clay), color (which can indicate organic content), and structure (refers to how soil particles are arranged)."
            },
            {
                "marks": 4,
                "question": "Explain the role of humans in resource development.",
                "reference_answer": "Humans play a crucial role in resource development through activities like mining for minerals, farming for food production, and managing water resources. Their actions impact the sustainability and availability of these resources."
            }
]
        '''
...
def health_check():
    ...
    return jsonify({
        "status": "healthy",
        "message": "QA Mapping API with Webhook is running",
        "timestamp": datetime.now().isoformat(),
        "database_url": DATABASE_URL,
        "webhook_url": WEBHOOK_URL,
        "webhook_configured": WEBHOOK_URL is not None,
        "features": ["QA Processing", "Semantic Matching", "OpenAI Integration", "Webhook Notifications"],
        "database_structure": "Updated for nested chunk_data structure"
    }), 200
...
@app.route('/api/reference-questions', methods=['GET'])
...
def not_found(error):
    return jsonify({
        ...
        "available_endpoints": [
            ...
            "GET /api/reference-questions - Get reference questions",
...
if __name__ == '__main__':
    ...
    logger.info(f"Starting QA Mapping Flask API with Webhook on {host}:{port}")
    ...
    print("  GET  /api/reference-questions       - Get reference questions")
